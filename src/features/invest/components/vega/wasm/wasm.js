...
export class PlotData {
    ...
    toJSON() {
        return {
            mean: this.mean,
            percentile10: this.percentile10,
            percentile5: this.percentile5,
            percentile90: this.percentile90,
 ...
 * @returns {PlotData}
 */
export function curve_data(csv_text, num_investors, trading_cost, level, hold, participation) {
    const ptr0 = passStringToWasm0(csv_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.curve_data(ptr0, len0, num_investors, trading_cost, level, hold, participation);
    return PlotData.__wrap(ret);
}
import * as import1 from "./snippets/wasm-4b0f351a8e6eeb46/rand.ts"
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wasm_bg.js": import0,
        "./snippets/wasm-4b0f351a8e6eeb46/rand.ts": import1,
    };
}
