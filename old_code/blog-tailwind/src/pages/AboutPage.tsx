        ...
        <div className="max-w-[800px] mx-auto">
            ...
            <section className="flex flex-col gap-12">
                <div className="flex gap-8 items-center flex-wrap flex-col md:flex-row text-center md:text-left">
                    <div className="w-[120px] h-[120px] bg-gradient-to-br from-primary to-gray-700 rounded-full flex items-center justify-center text-4xl flex-shrink-0 md:w-[100px] md:h-[100px]">
                        👨‍💻
                    </div>
